...
def update_line(hl, new_data_x, new_data_y):
    ...
    plt.plot(new_data_x, new_data_y, '*')
	#plt.draw()
...
while m < limit_mi:
	...
	if count_plot == 20:
		count_x_plot = count_x_plot + 1
		x_values = np.append(x_values, count_x_plot)
		y = np.append(y, force)
		count_plot = count_plot + 1
	#print(x_values)
	#print('\n')
	...
	#update_line(fig, count_x_plot, force)
