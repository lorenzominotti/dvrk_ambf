...
while m < limit_mi:
	count_tot1 = count_tot1 + 1
	while count_sub < lim_substeps:
		...
		if count_sub == 0:
			force_pl = force
			graph_f = np.append(graph_f, force_pl)
			count_up = count_up + 1
...
while degree < 15:
	...
	if count_substep == 2:
		...
		freq = 1/time_s
		graph_freq = np.append(graph_freq, freq)
		#print(force)
		#print("\n")
		#degree = degree + delta_degree
		time.sleep(f_inv)
