...
print("\n")
pos_yaw_raw = psm_handle_yaw.get_pos()
print("POS YAW")
print(psm_handle_yaw.get_pos())
print(psm_handle_yaw.get_rpy())
psm_handle_yaw.set_rpy(1.5707963267948957, 0.03400000033332262, 3.139000000333287)
time.sleep(1)
print("\n")
print("POS PBackL")
print(psm_handle_pbackl.get_pos())
print("\n")
print("POS PFrontL")
print(psm_handle_pfl.get_pos())
print("\n")
print("POS MIl")
print(psm_handle_mi.get_pos())
print("\n")
print("POS TRL")
...
print("MOVE")
time.sleep(2)
psm_handle_mi.set_pos(1.4558062843482137, -0.4012031646000947, 0.2727832775073985)
