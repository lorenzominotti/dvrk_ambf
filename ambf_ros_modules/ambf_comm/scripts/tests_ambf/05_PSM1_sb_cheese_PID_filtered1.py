...
while degree < 20:
	...
	if count == 16:
		...
		print(force_raw)
		b, a = signal.butter(4, 0.0001)
		zi = signal.lfilter_zi(b, a)
		z, _ = signal.lfilter(b, a, force_raw, zi=zi*force_raw[0])
		z2, _ = signal.lfilter(b, a, z, zi=zi*force_raw[0])
		z3, _ = signal.lfilter(b, a, z2, zi=zi*force_raw[0])
		force_f = signal.filtfilt(b, a, force_raw, axis=0)
		force = force_f[-1]
	else:
		force_raw = np.append(force_raw, force_raw_now)
		force = force_raw_now
