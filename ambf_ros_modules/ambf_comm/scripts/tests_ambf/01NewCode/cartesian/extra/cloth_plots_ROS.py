...
def subs():
	...
	#sb_ = rospy.Subscriber("", Float64, callback_)
...
def test_plot():
	...
	graph_py = graph_py[0:(max_len-limit)]
	...
	axs[0].plot(time, graph_px, label = "posx")
	axs[0].plot(time, graph_py, label = "posy")
	axs[0].set(ylabel = 'pos_xy [cm]')
	...
	axs[1].plot(time, graph_pz, label = "posz")
