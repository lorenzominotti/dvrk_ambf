...
class Joint_control:
	...
	def plots(self):
		...
		np.savetxt('ambf/ambf_ros_modules/ambf_comm/scripts/tests_ambf/01NewCode/test_plots/joints/joints2/09_cl_joint_error.csv', self.er1, delimiter=",")
		np.savetxt('ambf/ambf_ros_modules/ambf_comm/scripts/tests_ambf/01NewCode/test_plots/joints/joints2/10_cl_joint_error.csv', self.er2, delimiter=",")
