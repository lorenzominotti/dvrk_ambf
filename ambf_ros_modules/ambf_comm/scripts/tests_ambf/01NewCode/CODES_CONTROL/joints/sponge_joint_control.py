...
class Joint_control:
	...
	def plots(self):
		...
		np.savetxt('ambf/ambf_ros_modules/ambf_comm/scripts/tests_ambf/01NewCode/test_plots/joints/joints2/09_sp_joint_error.csv', self.er1, delimiter=",")
		np.savetxt('ambf/ambf_ros_modules/ambf_comm/scripts/tests_ambf/01NewCode/test_plots/joints/joints2/10_sp_joint_error.csv', self.er2, delimiter=",")
...
def main():
	...
	joint_c.reach_XY_force_control(-0.01, -0.08, True)
	joint_c.reach_XY_force_control(-0.08, 0.02, False)
	joint_c.plots()
