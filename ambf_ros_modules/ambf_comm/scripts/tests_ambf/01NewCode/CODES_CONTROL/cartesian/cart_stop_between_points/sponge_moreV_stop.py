...
class Cartesian_control:
	...
	#Get in contact with an object and reach a certain target force	
	def approach_goal_Z(self, m_start):
		...
		while self.m < self.limit_mi:
			...
			self.publish_to_plot(0,0,0,0,-0.2175,0,0,-0.2175)

			self.graph_px = np.append(self.graph_px, 0)
			self.graph_py = np.append(self.graph_py, 0)
			self.graph_pz = np.append(self.graph_pz, -0.2175)#soft
			...
			self.pz = np.append(self.pz, -0.2175)
			...
			self.graph_pzd = np.append(self.graph_pzd, -0.2175)
	...
	def plot_properties(self):
		...
		np.savetxt('ambf/ambf_ros_modules/ambf_comm/scripts/tests_ambf/01NewCode/test_properties/02_sp_kMT_t.csv', time, delimiter=",")
		np.savetxt('ambf/ambf_ros_modules/ambf_comm/scripts/tests_ambf/01NewCode/test_properties/02_sp_kMT_f.csv', self.f, delimiter=",") 
		np.savetxt('ambf/ambf_ros_modules/ambf_comm/scripts/tests_ambf/01NewCode/test_properties/02_sp_kMT_fd.csv', self.fd, delimiter=",")
		np.savetxt('ambf/ambf_ros_modules/ambf_comm/scripts/tests_ambf/01NewCode/test_properties/02_sp_kMT_z.csv', self.z, delimiter=",")
		
		#np.savetxt('ambf/ambf_ros_modules/ambf_comm/scripts/tests_ambf/01NewCode/test_plots/joints/joints2/01_rb_joint_error.csv', self.er1, delimiter=",")
		#np.savetxt('ambf/ambf_ros_modules/ambf_comm/scripts/tests_ambf/01NewCode/test_plots/joints/joints2/02_rb_joint_error.csv', self.er2, delimiter=",")
	...
	def plot_force(self):
		...
		#np.savetxt('ambf/ambf_ros_modules/ambf_comm/scripts/tests_ambf/01NewCode/test_plots/001_rb_cart_time.csv', time2, delimiter=",")
		#np.savetxt('ambf/ambf_ros_modules/ambf_comm/scripts/tests_ambf/01NewCode/test_plots/001_rb_cart_force.csv', self.graph_f2, delimiter=",") 
		#np.savetxt('ambf/ambf_ros_modules/ambf_comm/scripts/tests_ambf/01NewCode/test_plots/001_rb_cart_forced.csv', self.graph_fd2, delimiter=",") 
		#np.savetxt('ambf/ambf_ros_modules/ambf_comm/scripts/tests_ambf/01NewCode/test_plots/joints/joints2/01_sp_joint_error.csv', self.er1, delimiter=",")
		#np.savetxt('ambf/ambf_ros_modules/ambf_comm/scripts/tests_ambf/01NewCode/test_plots/joints/joints2/02_sp_joint_error.csv', self.er2, delimiter=",")
		...
		axs[2].plot(time, self.graph_pxd,color = 'b', label = "X_des")
		axs[2].plot(time, self.graph_px,color = 'g', label = "X_read")
		axs[2].set(ylabel = 'posX [m]')		
		axs[2].legend(loc='best')
		axs[2].grid()

		axs[3].plot(time, self.graph_pyd,color = 'b', label = "Y_des")
		axs[3].plot(time, self.graph_py,color = 'g', label = "Y_read")
		axs[3].set(ylabel = 'posY [m]')		
		axs[3].legend(loc='best')
		axs[3].grid()


		
		axs[4].plot(time, self.graph_pzd, color = 'b', label = "Z_des")
		axs[4].plot(time, self.graph_pz, color = 'g', label = "Z_read")
		axs[4].set(ylabel = 'posZ [m]')	
		axs[4].legend(loc='best', fontsize = 'small')
...
def main():
	...
	########this two!!!!!!!!
	cart_c.reach_XY_force_control(0.03, 0.07)
	cart_c.reach_XY_force_control(0.06, -0.04)
