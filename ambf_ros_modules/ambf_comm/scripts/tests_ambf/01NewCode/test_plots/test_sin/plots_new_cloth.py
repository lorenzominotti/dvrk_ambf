...
axs[1].plot(time, force_cl_02, color = 'r', label = "F_read 0.5Hz")
axs[1].plot(time, forced_cl_02, color = 'b', label = "F_taget 0.5Hz")	
axs[1].set(ylabel = 'Force [N]')	
axs[1].legend(loc='best')
axs[1].grid()

axs[2].plot(time, force_cl_03, color = 'r', label = "F_read 1Hz")
axs[2].plot(time, forced_cl_03, color = 'b', label = "F_taget 1Hz")	
axs[2].set(ylabel = 'Force [N]')	
axs[2].legend(loc='best')
axs[2].grid()
	
axs[3].plot(time, error_cl_01, color = 'r', label = "err 0.1Hz")
axs[3].plot(time, error_cl_02, color = 'b', label = "err 0.5Hz")
axs[3].plot(time, error_cl_03, color = 'g', label = "err 1Hz")
