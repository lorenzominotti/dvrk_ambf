...
axs[0].plot(time, force_sp_03, color = '#3371ff', label = "F kMT=0.0005")
axs[0].plot(time, force_sp_02, color = '#ff9f33', label = "F kMT=0.005")
axs[0].plot(time, force_sp_01, color = '#ff335e', label = "F kMT=0.05")
...
axs[1].grid()
'''
axs[1].plot(time, z_sp_03, color = '#3371ff', label = "Z kMT=0.0005")
axs[1].plot(time, z_sp_02, color = '#ff9f33', label = "Z kMT=0.005")
axs[1].plot(time, z_sp_01, color = '#ff335e', label = "Z kMT=0.05")
